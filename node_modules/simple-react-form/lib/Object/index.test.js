...
it('should render correctly', function () {
  var component = (0, _enzyme.mount)(_react2.default.createElement(
    ...
    _react2.default.createElement(
      _Field2.default,
      { fieldName: 'object', type: _index2.default },
...
it('should show an error if it has one', function () {
  var component = (0, _enzyme.mount)(_react2.default.createElement(
    ...
    _react2.default.createElement(
      _Field2.default,
      { fieldName: 'object', type: _index2.default, errorMessage: 'I AM AN ERROR' },
      _react2.default.createElement('div', { className: 'children' })
    )
  ));
...
it('should render the label', function () {
  var component = (0, _enzyme.mount)(_react2.default.createElement(
    ...
    _react2.default.createElement(
      _Field2.default,
      { fieldName: 'object', type: _index2.default, label: 'I AM A LABEL!' },
      _react2.default.createElement('div', { className: 'children' })
    )
  ));
